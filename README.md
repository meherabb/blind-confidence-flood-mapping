...
<p align="center">
  <img src="results/figures/Pipeline diagram.png" width="640" alt="End-to-end pipeline: data pooling and filtering, the synthetic cloud-severity ladder, four models evaluated identically at every severity, per-chip metrics, three families of diagnostic analysis, and the three resulting findings">
</p>
